    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header bg-umy">{{ __('Detail Fakultas') }}</div>
                    <div class="card-body">
                        <form action="{{ route('faculty.update', compact('faculty')) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" required class="form-control @error('name') is-invalid @enderror" value="{{ $faculty->name }}">
                                @error('name')
