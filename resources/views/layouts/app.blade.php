    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-umy shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{ asset('images/icon.png') }}" width="30" height="30"
                     class="d-inline-block align-bottom mr-1" alt="{{ config('app.name', 'Laravel') }}">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <a class="dropdown-item"
                                       href="{{ route('activity.index') }}">{{ __('Jenis Kegiatan') }}</a>
                                    <a class="dropdown-item"
                                       href="{{ route('participant.index') }}">{{ __('Jenis Peserta') }}</a>
                                    <a class="dropdown-item"
                                       href="{{ route('financial.index') }}">{{ __('Jenis Biaya') }}</a>
                                    <a class="dropdown-item"
                                       href="{{ route('attachment.index') }}">{{ __('Jenis Lampiran') }}</a>
                                    <a class="dropdown-item"
                                       href="{{ route('faculty.index') }}">{{ __('Fakultas') }}</a>
                                    <a class="dropdown-item"
                                       href="{{ route('study.index') }}">{{ __('Program Studi') }}</a>
                                    <a class="dropdown-item"
                                       href="{{ route('category.index') }}">{{ __('Kategori') }}</a>
                                </div>
                            </li>
                        @endif
                        <li class="nav-item">
